...
function(FLEX_BISON_SOURCE TARGET LEXFNAME YFNAME LEXCPP YCPP YHPP)
	...
	FLEX_TARGET("${LEXCPP}" "${LEXFNAME}" "${CMAKE_CURRENT_BINARY_DIR}/${LEXCPP}")
	BISON_TARGET("${YCPP}" "${YFNAME}" "${CMAKE_CURRENT_BINARY_DIR}/${YCPP}" DEFINES_FILE "${CMAKE_CURRENT_BINARY_DIR}/${YHPP}")
